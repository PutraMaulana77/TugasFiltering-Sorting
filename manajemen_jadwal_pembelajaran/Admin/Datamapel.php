...
<div class="container mt-3">
  <form action="" method="get" class="d-flex">
    <!-- Tombol TAMBAH -->
    <a class="btn btn-primary" href="tambah2.php">+ TAMBAH</a>
  ...
  <table id="myTable" class="table table-striped table-bordered mt-1">
      ...
      ?>
        <tr>
          ...
          <td>
            <a href="edit2.php?id=<?php echo $d['ID_Mapel']; ?>" class="btn btn-success btn-sm mr-2">UBAH</a>
            <a href="hapus2.php?id_mapel=<?php echo $d['ID_Mapel']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin akan menghapus data ini?')">HAPUS</a>
          </td>
        </tr>
      <?php 
      }
